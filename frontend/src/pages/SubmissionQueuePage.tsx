...
export default function SubmissionQueuePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {message ? (
        <Card className="rounded-[24px] border-white/70 bg-white/90 shadow-soft dark:border-slate-700/80 dark:bg-slate-950/92">
      ...
      >
        <DialogContent className="max-w-4xl rounded-[28px] border-white/70 bg-white/95 p-0 shadow-soft sm:max-w-4xl dark:border-slate-700/80 dark:bg-slate-950/96">
          {selectedSubmission ? (
            <>
              ...
              <div className="space-y-6 px-6 pb-2">
                <div className="grid gap-4 md:grid-cols-3">
                  <Card className="rounded-2xl border-white/70 bg-muted/30 shadow-none dark:border-slate-700/80 dark:bg-slate-900/88">
