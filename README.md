...
Run database migrations and schema checks locally:

```bash
python scripts/verify-production-integrity.py
```

### Deployment

See the [Production deployment guide](docs/PRODUCTION_DEPLOYMENT.md) for the preflight checklist, schema migration runbook, and verification steps.

> **Note:** Do not publish secrets, production endpoints, student data, or internal credentials to public version control.

---

## License

Internal school project — all rights reserved to the Codify school coding club team.
