...
import { adminUsersHandler, adminCreateUserHandler, adminSetUserGradeHandler } from "./handlers/adminUsers";
...
const routes: Route[] = [
  ...
  { method: "POST", path: "/api/admin/users/set-grade", middlewares: adminOnly, handler: adminSetUserGradeHandler },
